...
document.querySelector("label").nextElementSibling
...
document.querySelectorAll("img").forEach(e => {
    let n = 0;
    console.log(`The total number of img element is ${++n}`);
});
...
console.log("parent element :",topics.parentElement);
...
console.log("parant elem of fieldset:",typeof(fieldsetElm.parentElement));
